...
server.on("post_initialize", function () {
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: 1000});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: auftrag.gutteile});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: auftrag.schlechtteile});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: zyklus.referenzWert});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: zyklus.istWert});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: zyklus.toleranzWert});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: umschaltspritzdruck.referenzWert});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: umschaltspritzdruck.istWert()});
      }
    }
  });
  ...
  addressSpace.addVariable({
    ...
    value: {
      get: function () {
        return new Variant({dataType: DataType.Double, value: umschaltspritzdruck.toleranzWert});
      }
    }
  });
